  ...
  return (
    <Box className={classes.cards}>
      ...
      <Box className={classes.contantCard}>
        <Box>
          ...
          >
            ...
            {/* <FaRegHeart
              style={
                data.bundleDetails[0] && data.bundleDetails[0].isLike
                  ? { color: 'red', transition:"all .1s linear","&:hover":{transform:"scale(1.1)",} }
                  : {transition:"all .1s linear","&:hover":{transform:"scale(1.1)",}
              }
              onClick={() =>
        ...
        >
          {data.masPrice}{" "}
          <span style={{ color: "#fff", fontWeight: 500 }}>MAS</span>
        </Typography>
        <Typography variant="h6" component="h6" style={{ color: "#fff" }}>
          ...
          <span style={{ color: "#FFF" }}>{moment(data.validTillDate).format("DD-MM-YYYY hh:mm A")}</span>
        </Typography>
        <Typography
          className="textOverflow"
          style={{
...
export function SubscribtionsCardPopup({
  ...
  const donationHandler = async () => {
    if (parseFloat(donationAmount) < parseFloat(auth.userData.massBalance)) {
      try {
        setIsDonating(true);
              ...
              <Box>
                <Grid container spacing={2}>
                  <Grid item xs={12} md={4}>
                    <label> {t("bundles.donationAmount")}</label>
                  </Grid>
                  <Grid item xs={12} md={4}>
                    <TextField
                      id="standard-basic"
                ...
                <Grid container alignItems="center" spacing={2}>
                  ...
                  <Grid item md={6}>
                    <Button
                      ...
                      disabled={isDonating}
                    >
                      {t("bundles.donate")} {isDonating && <ButtonCircularProgress />}
                    </Button>
                  </Grid>
                </Grid>
              </Box>
