      ...
      <Box className={classes.contantCard}>
            ...
            {!disableTimer && (
              <>
                {moment(data?.nftId?.time).unix() < moment().unix() ? (
                  ...
                  <List className={classes.timeing}>
                    <ListItem>
                      {closeTimeLeft?.days ? closeTimeLeft?.days : "0"} {t("bundles.expired")}
                    </ListItem>
                    <ListItem>
                      {closeTimeLeft?.hours ? closeTimeLeft?.hours : "0"} {t("bundles.expired")}
                    </ListItem>
                    <ListItem>
                      {closeTimeLeft?.minutes ? closeTimeLeft?.minutes : "0"} {t("bundles.expired")}
                    </ListItem>
                    <ListItem>
                      {closeTimeLeft?.seconds ? closeTimeLeft?.seconds : "0"} {t("bundles.expired")}
                    </ListItem>
                  </List>
                )}
              </>
        ...
        >
          ...
          >
            ...
            {data?.userId?.planType === "Mass Plus" && (
              <img
                src="images/icon.png"
                alt="Mass Plus"
                style={{ width: "30px", marginLeft: "5px" }}
