...
const useStyles = makeStyles((theme) => ({
  ...
  btn: {
    ...
    width: "90%",
    margin: "10px auto",
    borderRadius: "10px", padding: "10px 20px 10px 12px!important",
    textAlign: "center",
    color: "#fff",
  ...
  return (
    <Box className={classes.LoginBox}>
      <Grid className={classes.CoverBox}>
        ...
        <Box className={classes.coverEdit} style={{ cursor: "pointer" }}>
      ...
      <Container maxWidth="xl">
        <Box className={classes.profile}>
          <img
            ...
            alt=""
          />
          <Box className={classes.profileFoto} >
            ...
            <input
              ...
              onChange={(e) => {
                ...
                photoIsFun(e.target.value)
                getBase64(e.target.files[0], (result) => {
                  setprofile(result);
                });
              }}
            />
            {noPhoto == true && <div style={{ color: "red", fontSize: "17px" }}>
              plaese Add Your Photo
            </div>}
          </Box>
        </Box>
        <Box>
          <Grid container spacing={1}>
            <Grid item xs={12} md={1}>
              <label className={classes.name}> {t("profile.name")}</label>
            </Grid>
        ...
        <Box style={{ marginTop: "-10px" }}>
          <Grid container spacing={1}>
            <Grid item xs={12} md={1}>
              <label className={classes.name}>   {t("profile.email")}</label>
            </Grid>
            <Grid item xs={12} md={4}>
              <TextField
                id="standard-basic"
          ...
          <Grid container spacing={1}>
            <Grid item xs={12} md={6}>
              ...
              <label className={classes.name}>
                {t("profile.masPageUrl")}{" "}
                <p style={{ paddingTop: "15px" }}>‎‎‎https://apps.masplatform.io/user-profile?</p> &nbsp;
                <TextField
                  id="outlined-basic"
                  autoFocus="true"
                  value={url}
          ...
          <Grid container spacing={1}>
            {user.userData?.referralCode && (
              <Typography variant="h6" style={{ color: "#FFF" }}>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                {user.userData?.referralCode} &nbsp;
                <CopyToClipboard text={user.userData?.referralCode} style={{ color: "#FFF", cursor: "pointer", }}>
                  <FiCopy onClick={() => toast.info("Copied")} />
                </CopyToClipboard>
              </Typography>
            )}
        ...
        <Box>
          <Grid container spacing={1} style={{ alignItems: "center" }}>
            <Grid item xs={12} md={4}>
              <label className={classes.name}>{t("profile.bio")}</label>
              <TextField
