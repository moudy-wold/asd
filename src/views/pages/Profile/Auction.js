...
import { getContract, getWallet, getContractWallet } from "src/utils";
    ...
    <Box className={classes.LoginBox} mb={5}>
            ...
            <Box mb={2}>
              <Grid container spacing={0}>
                <Grid item xs={12} md={4}>
                  <label>{t("auctions.expiryTime")}</label>
                </Grid>
      ...
      {importNFtPop && (
        <Dialog
          ...
          disableEscapeKeyDown={process}
        >
          <DialogTitle className={classes.dailogTitle}>  {t("auctions.importNFT")}</DialogTitle>
          <DialogContent>
            {auth.isErrorInWalletConnect && (
              <Box mb={3}>
                <FormHelperText error>{auth.connectWalletError}</FormHelperText>
                        ...
                        <>
                          ...
                          <Box>
                            <Button
                              ...
                              component="span"
                            >
                              {t("auctions.uploadedSuccessfully")}
                            </Button>
                          </Box>
                        </>
                      ) : (
            ...
            <Box mb={2}>
              <Grid container spacing={0}>
                <Grid item xs={12} md={4}>
                  <label>{t("auctions.startingBid")}</label>
                </Grid>
                <Grid item xs={12} md={8}>
                  <Input
                    placeholder=""
