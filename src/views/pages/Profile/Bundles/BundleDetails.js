...
const useStyles = makeStyles((theme) => ({
  root: { padding: "70px 0px", backgroundColor: "#441682", },
  bannerimg: {
    overflow: "hidden",
  ...
  btn: {
    ...
    color: "#fff",
    marginLeft: "10px",
    background: "linear-gradient(270deg, #882ea3, #22c37f)!important",
          ...
          <Box className={classes.headbox2}>
            <Box style={{ display: "flex", flexWrap: "wrap" }}>
              <Box
                ...
                // style={{ background: "url('./images/my-photo.jpg')" }}
              ...
              <Box className={`${classes.text1} seats`}>
                ...
                <Box mt={1}>
                  ...
                  <Box
                    ...
                    className={classes.bundleData}
                  >
                    <Typography variant="h4"> {t("bundles.timeDuration")} </Typography>&nbsp;
                    <Typography variant="h4">
